...
parser = argparse.ArgumentParser(description="EM simulation of the WPD")
...
parser.add_argument("--config", type=str, default=DEFAULT_CONFIG, help="Configuration of the WPD (C, U)")
...
# The name must match WPD_GDS_FILENAME in the Makefile (sim-wpd-em target)
