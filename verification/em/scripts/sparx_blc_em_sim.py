...
port1 = c.add_ref(gf.components.rectangle(size=(0.1, blc_ref.ports["e1"].width), layer=(201,0)))
port1.center = (blc_ref.ports["e1"].center)
port1.move((0.05,0))

port2 = c.add_ref(gf.components.rectangle(size=(0.1, blc_ref.ports["e2"].width), layer=(202,0)))
port2.center = (blc_ref.ports["e2"].center)
port2.move((-0.05,0))

port3 = c.add_ref(gf.components.rectangle(size=(0.1, blc_ref.ports["e3"].width), layer=(203,0)))
port3.center = (blc_ref.ports["e3"].center)
port3.move((-0.05,0))

port4 = c.add_ref(gf.components.rectangle(size=(0.1, blc_ref.ports["e4"].width), layer=(204,0)))
