...
N 1200 -1260 1200 -1220 {lab=#net1}
N 1040 -1300 1040 -1260 {lab=#net1}
N 1280 -1260 1440 -1260 {lab=#net2}
N 1280 -1260 1280 -1220 {lab=#net2}
N 1440 -1300 1440 -1260 {lab=#net2}
...
N 1280 -1020 1280 -940 {lab=#net3}
N 1280 -940 1360 -940 {lab=#net3}
N 1280 -860 1360 -860 {lab=#net4}
N 1280 -860 1280 -780 {lab=#net4}
N 1120 -940 1200 -940 {lab=#net5}
N 1200 -1020 1200 -940 {lab=#net5}
N 1200 -860 1200 -780 {lab=#net6}
N 1120 -860 1200 -860 {lab=#net6}
N 840 -900 920 -900 {lab=#net7}
N 560 -900 640 -900 {lab=vlo}
N 1560 -860 1640 -860 {lab=#net8}
N 1560 -940 1720 -940 {lab=vrf}
N 1040 -540 1200 -540 {lab=#net9}
N 1200 -580 1200 -540 {lab=#net9}
N 1040 -540 1040 -500 {lab=#net9}
N 1280 -540 1440 -540 {lab=#net10}
N 1280 -580 1280 -540 {lab=#net10}
N 1440 -540 1440 -500 {lab=#net10}
...
C {sparx_blc_le.sym} 1240 -1120 3 0 {name=x5}
C {sparx_powdet_sbd.sym} 1440 -1380 3 0 {name=x2}
C {sparx_blc_le.sym} 1460 -900 0 0 {name=x6}
C {sparx_wpd_le.sym} 1020 -900 0 0 {name=x7}
C {sparx_bpf_le.sym} 740 -900 0 0 {name=x8}
...
C {sparx_blc_le.sym} 1240 -680 3 1 {name=x4}
...
C {iopin.sym} 560 -980 2 0 {name=p4 lab=vss}
C {iopin.sym} 560 -820 2 0 {name=p5 lab=vss}
C {iopin.sym} 1720 -860 0 0 {name=p9 lab=vss}
C {iopin.sym} 1720 -1020 0 0 {name=p10 lab=vss}
